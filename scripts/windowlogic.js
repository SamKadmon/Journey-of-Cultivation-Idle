...
function createWindow(title, contents) 
{
    ...
    var windowcontents = document.createElement("object");
    windowcontents.setAttribute("type","text/html");
    windowcontents.setAttribute("data",contents);
...
document.addEventListener('click', e => {
    ...
    if (e.target.closest('.taskbar-startbutton')) 
    {
		createWindow("Window Spawn Testing", "spawntest.html");
	}
});
...
document.addEventListener('mousedown', e => {
    ...
    {
        setTop(e.target.closest('.window'));
    }
});